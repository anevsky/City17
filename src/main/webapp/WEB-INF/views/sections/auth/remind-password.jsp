	...
	<div class="wrapper">
		...
		<div class="content">
			<div id="form_wrapper" class="form_wrapper">
				...
				<form class="forgot_password active" name="forgot-password" action="doRemindPassword" method="post">
					<h3>Forgot Password</h3>
					<div>
						<label>Username or Email:</label> <input type="text" /> <span class="error">This is an error</span>
					</div>
					<div class="bottom">
						<input type="submit" value="Send reminder"></input> <a href="login" rel="login" class="linkform">Suddenly
							remembered? Log in here</a> <a href="signup" rel="signup" class="linkform">You don't have an account? Register
							here</a>
						<div class="clear"></div>
					</div>
				</form>
