	...
	<div class="wrapper">
		...
		<div class="content">
			<div id="form_wrapper" class="form_wrapper">
				...
				<form class="login active" name="login" action="doLogin" method="post">
					<h3>Login</h3>
					<div>
						<label>Username:</label> <input type="text" /> <span class="error">This is an error</span>
					</div>
					<div>
						<label>Password: <a href="remind-password" rel="remind-password" class="forgot linkform">Forgot your
								password?</a></label> <input type="password" /> <span class="error">This is an error</span>
					</div>
					<div class="bottom">
						<div class="remember">
							<input type="checkbox" /><span>Keep me logged in</span>
						</div>
						<input type="submit" value="Login"></input> <a href="signup" rel="signup" class="linkform">You don't have an
