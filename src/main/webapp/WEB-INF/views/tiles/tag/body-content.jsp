				...
				<div id="mainbar-full" class="super-site-show-new">
					...
					<div>
						...
						<div id="super-site-panel-paragraphs" class="super-site-panel super-site-panel-left">
							...
							<nav>
								<p>
									<a href="<c:url value="${tagUrl}/page/1" />"><spring:message code="first" /></a>
									 | 
									 <a href="<c:url value="${tagUrl}/page/${prevPage}" />"><spring:message code="prev" /></a>							  
									 -| ${pagesNumStr} |- 
									 <a href="<c:url value="${tagUrl}/page/${nextPage}" />"><spring:message code="next" /></a> 
									 | 
									 <a href="<c:url value="${tagUrl}/page/${lastPage}" />"><spring:message code="last" /></a>
								</p>
							</nav>
